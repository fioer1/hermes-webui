...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_label_auto_titles: 'Auto-generate chat titles',
    settings_desc_auto_titles: 'Runs a small title-generation request after the first exchange.',
    settings_label_prompt_cache: 'Use chat completions cache',
    settings_desc_prompt_cache: 'Routes this profile through chat completions so compatible providers can reuse cached prompt tokens.',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    settings_label_auto_titles: '自动生成会话标题',
    settings_desc_auto_titles: '首次对话后额外运行一次小的标题生成请求。',
    settings_label_prompt_cache: '启用 Chat Completions 缓存',
    settings_desc_prompt_cache: '让当前 profile 走 chat completions，使兼容供应商复用已缓存的前置 prompt token。',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_label_auto_titles: '自動產生會話標題',
    settings_desc_auto_titles: '首次對話後額外執行一次小的標題產生請求。',
    settings_label_prompt_cache: '啟用 Chat Completions 快取',
    settings_desc_prompt_cache: '讓目前 profile 走 chat completions，使相容供應商重用已快取的前置 prompt token。',
